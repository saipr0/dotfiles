return {
  ...
  },
  {
    ...
    config = function()
      ...
      vim.api.nvim_set_hl(0, 'StatusLine', { bg = '#1c1f26', fg = '#d4d7dd' })
      vim.api.nvim_set_hl(0, 'StatusLineNC', { bg = '#14171d', fg = '#7c8490' })
      vim.api.nvim_set_hl(0, 'StatusLineFile', { bg = '#262b35', fg = '#e5e7eb', bold = true })
      vim.api.nvim_set_hl(0, 'StatusLineFileNC', { bg = '#1a1e26', fg = '#9ca3af' })
      vim.api.nvim_set_hl(0, 'StatusLineInfo', { bg = '#1c1f26', fg = '#aab2bf' })
      vim.api.nvim_set_hl(0, 'StatusLineInfoNC', { bg = '#14171d', fg = '#6b7280' })
      
      -- Fix split line - remove yellow background
      vim.api.nvim_set_hl(0, 'VertSplit', { bg = 'none', fg = '#5f6672' })
      vim.api.nvim_set_hl(0, 'WinSeparator', { bg = 'none', fg = '#5f6672' })
